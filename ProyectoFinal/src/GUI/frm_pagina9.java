...
public class frm_pagina9 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/perfil yeis.jpeg"))); // NOI18N
        ...
        jTextField1.setText("YeisMina Florez Io111");
        ...
        jPanel1.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 320, 220, -1));

        jLabel6.setFont(new java.awt.Font("Tw Cen MT Condensed Extra Bold", 0, 14)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(153, 153, 153));
        jLabel6.setText("Seguidores 2220- Suiguiendo 500");
        ...
        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/desagrado (1).jpeg"))); // NOI18N
        jPanel1.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 470, 200, 190));

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/buz.jpeg"))); // NOI18N
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 470, 190, 190));

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/descarga (16).jpeg"))); // NOI18N
        jLabel7.setText("jLabel7");
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 90, 530, 190));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/zootopia.jpeg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_pagina9.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_pagina9().setVisible(true);
            }
        });
    }
